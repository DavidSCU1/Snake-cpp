...
template <> constexpr inline auto LocalCoopCharacterSelection::qt_create_metaobjectdata<qt_meta_tag_ZN27LocalCoopCharacterSelectionE_t>()
{
    ...
    QtMocHelpers::UintData qt_methods {
        ...
        QtMocHelpers::SignalData<void(CharacterType, CharacterType, SinglePlayerMode)>(1, 2, QMC::AccessPublic, QMetaType::Void, {{
...
void LocalCoopCharacterSelection::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: _t->startLocalCoopGame((*reinterpret_cast< std::add_pointer_t<CharacterType>>(_a[1])),(*reinterpret_cast< std::add_pointer_t<CharacterType>>(_a[2])),(*reinterpret_cast< std::add_pointer_t<SinglePlayerMode>>(_a[3]))); break;
    ...
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (LocalCoopCharacterSelection::*)(CharacterType , CharacterType , SinglePlayerMode )>(_a, &LocalCoopCharacterSelection::startLocalCoopGame, 0))
            return;
...
// SIGNAL 0
void LocalCoopCharacterSelection::startLocalCoopGame(CharacterType _t1, CharacterType _t2, SinglePlayerMode _t3)
{
