...
template <> constexpr inline auto SingleModeSelection::qt_create_metaobjectdata<qt_meta_tag_ZN19SingleModeSelectionE_t>()
{
    ...
    QtMocHelpers::UintData qt_methods {
        ...
        QtMocHelpers::SlotData<void(const Achievement &)>(8, 2, QMC::AccessPrivate, QMetaType::Void, {{
            { 0x80000000 | 9, 10 },
        }}),
        // Slot 'showAchievements'
        QtMocHelpers::SlotData<void()>(11, 2, QMC::AccessPrivate, QMetaType::Void),
        // Slot 'animateButton'
        QtMocHelpers::SlotData<void(QPushButton *)>(12, 2, QMC::AccessPrivate, QMetaType::Void, {{
            { 0x80000000 | 13, 14 },
        }}),
    };
...
void SingleModeSelection::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 3: _t->onModeButtonClicked(); break;
        case 4: _t->onAchievementUnlocked((*reinterpret_cast< std::add_pointer_t<Achievement>>(_a[1]))); break;
        case 5: _t->showAchievements(); break;
        case 6: _t->animateButton((*reinterpret_cast< std::add_pointer_t<QPushButton*>>(_a[1]))); break;
        default: ;
        }
    }
    ...
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (SingleModeSelection::*)(SinglePlayerMode )>(_a, &SingleModeSelection::modeSelected, 0))
            return;
...
// SIGNAL 0
void SingleModeSelection::modeSelected(SinglePlayerMode _t1)
{
